...
function computeOperation (position, instruction) {
    ...
    switch(instruction) {
        ...
        case 2:
            ...
            return (position + 4);
        case 3:
            diagnostic[diagnostic[position + 1]] = inputInstruction;
            return (position + 2);
        case 4:
